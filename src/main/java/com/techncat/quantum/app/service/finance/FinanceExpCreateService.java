...
@Service
public class FinanceExpCreateService {
    ...
    public Exp create(ExpVO baseVO, ExpConferenceVO extraVO) {
    ...
    public Exp create(ExpVO baseVO, ExpConsultationVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpEquipmentVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpIndirectiveVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpInternationalVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpLaborVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpMaterialVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpOtherVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpProcessingVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpPublicationVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
    ...
    public Exp create(ExpVO baseVO, ExpTravelVO extraVO) {
        Assert.notNull(baseVO, "data can not be null");
        Assert.notNull(extraVO, "data can not be null");
